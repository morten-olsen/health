...
type IconTone = 'primary' | 'secondary' | 'tertiary' | 'inverse' | 'rest' | 'recover' | 'strain' | 'notice' | 'alert';
...
const PATHS: Record<IconName, string> = {
  ...
  pulse: 'M3 12H7L9 7L13 17L15 12H21',
  moon: 'M20 14.5C19.2 17.7 16.4 20 13 20C9 20 5.5 16.5 5.5 12.5C5.5 9 8 6 11.5 5.5C10.5 7 10 8.5 10 10C10 13.6 13 16.5 16.5 16.5C18 16.5 19.2 16 20 14.5Z',
  sun: 'M12 7V4 M12 20V17 M17 12H20 M4 12H7 M16.5 7.5L18.5 5.5 M5.5 18.5L7.5 16.5 M16.5 16.5L18.5 18.5 M5.5 5.5L7.5 7.5 M15.5 12C15.5 13.9 13.9 15.5 12 15.5C10.1 15.5 8.5 13.9 8.5 12C8.5 10.1 10.1 8.5 12 8.5C13.9 8.5 15.5 10.1 15.5 12Z',
  steps:
  ...
  drop: 'M12 4C8 9 6 12.5 6 15.5C6 18.5 8.5 21 12 21C15.5 21 18 18.5 18 15.5C18 12.5 16 9 12 4Z',
  lung: 'M12 4V14 M12 14C12 17 10 19 8 19C6 19 5 18 5 16C5 13 6.5 10 8 8 M12 14C12 17 14 19 16 19C18 19 19 18 19 16C19 13 17.5 10 16 8',
  ring: 'M12 4C16.4 4 20 7.6 20 12C20 16.4 16.4 20 12 20C7.6 20 4 16.4 4 12C4 7.6 7.6 4 12 4Z M12 7.5C14.5 7.5 16.5 9.5 16.5 12',
  path: 'M4 18C4 15 6 13 9 13C12 13 12 15 15 15C18 15 20 13 20 10C20 7 18 5 15 5',
  mountain: 'M3 19L9 9L13 15L15 12L21 19Z',
  spark:
    'M12 4V8 M12 16V20 M4 12H8 M16 12H20 M6.3 6.3L8.5 8.5 M15.5 15.5L17.7 17.7 M6.3 17.7L8.5 15.5 M15.5 8.5L17.7 6.3',
  leaf: 'M5 19C5 13 9 8 16 6C18 6 19 7 19 9C19 16 14 19 9 19C7 19 6 19 5 19Z M5 19C7 15 10 12 14 10',
...
const Icon = ({ name, size = 24, tone = 'primary', style }: IconProps): ReactNode => {
